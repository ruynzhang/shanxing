...
import com.dimeng.p2p.front.servlets.password.Index;
import com.dimeng.p2p.front.servlets.password.Reset;
import com.dimeng.util.StringHelper;
import com.dimeng.util.parser.IntegerParser;

public class Mpwd3 extends AbstractMobileServicer {
	...
	//end
		sendRedirect(request, response,getController().getViewURI(request, Mpwd3.class));
	}
