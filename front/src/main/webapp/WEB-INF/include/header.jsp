...
<div id="sx_menubox">
   <div class="sx_logo"><a href="<%configureProvider.format(out,URLVariable.INDEX);%>"><img src="<%=fileStore.getURL(configureProvider.getProperty(SystemVariable.QTLOGO))%>" title="<%configureProvider.format(out,SystemVariable.SITE_NAME);%>" alt="<%configureProvider.format(out,SystemVariable.SITE_NAME);%>"></a></div>
   <div class="sx_menu">
       ...
       <a href="<%=controller.getStaticPath(request)%>/guide.html" id="nav_4">理财攻略</a>
       <a href="<%=controller.getStaticPath(request)%>/safe/risk.html" id="nav_5">风险控制</a>
   </div>
   <div class="clear"></div>
</div>
</div>
