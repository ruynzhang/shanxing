		   ...
		   <div class="contain_main clearfix ">
		    ...
		    <%
                        ...
                        if(isResult && t6233s != null && t6233s.length >0){
              	           	 for (T6233 attachment : t6233s) {if (attachment == null) {continue;}%>
              	            	 <li><img src="<%=controller.getURI(request, Annex.class)%>?id=<%=attachment.F01 %>" width="185" height="116" />
              	            	 <p><%StringHelper.filterHTML(out, attachment.F04);%></p></li>
              	            <%}}else if(t6232s != null && t6232s.length >0){
              	            	for (T6232 attachment : t6232s) {if (attachment == null) {continue;}%>
           	   			    <li><img src="<%=fileStore.getURL(attachment.F04) %>" width="185" height="116" /><p><%StringHelper.filterHTML(out, attachment.F05);%></p></li>
           	            <%}} %>   
		    </ul>
		    <div class="clear"></div>
			</div>
