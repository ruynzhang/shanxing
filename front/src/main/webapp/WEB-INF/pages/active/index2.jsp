...
<body>
   ...
   <div class="sx_activebox">
    ...
    <div class="sx_act_f1 sx_act_border">
      ...
      <div class="sx_act_show2"><a href="<%configureProvider.format(out,URLVariable.REALNAME_AWARD_JUDGE);%>" class="sx_act_bt3 sx_act_rebBt" target="_blank">实名认证抽肾6</a><a href="<%configureProvider.format(out,URLVariable.REALNAME_AWARD_JUDGE);%>" class="sx_act_bt3 sx_act_blueBt" target="_blank">预约投标</a>
      <div class="sx_act_tip">实名认证后自动跳转到肾6抽奖页面（包括身份证、邮箱、提现密码认证）<span></span></div>
      </div>
    ...
    <div class="sx_act_f3 sx_act_border">
      ...
      <a href="<%configureProvider.format(out,URLVariable.REALNAME_AWARD_JUDGE);%>" class="sx_act_bt4" target="_blank">我要实名认证</a>
    </div>
    <div class="sx_act_f4 ">
    ...
    <div class="sx_act_f5">
      <img src="/images/active_06.jpg" alt="" />
    </div><br />
</div>
