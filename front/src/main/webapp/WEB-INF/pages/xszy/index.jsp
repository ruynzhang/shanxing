...
<html>
<head>
<title><%=ArticleType.XSZY.getName()%></title> 
...
<div class="sx_rookie">
   <div class="sx_rookie_block1">
      ...
      <p>当投资邂逅融资，带来前所未有的投资体验，让资金在全国绽放。善行创投，您的创投！！</p>
   </div>
   ...
   <div class="sx_intro_advantage">
      <ul>
        ...
        <li class="sx_advantage_middle">
           <span class="it2"></span>
           <h2>最安全的网上理财</h2>
           <p><b>7道</b>独创审核体系，<br /><b>本息有保障</b></p>
        </li>
        <li>
           <span class="it3"></span>
           <h2>随时随地赎回投资</h2>
  ...
  <div class="sx_rookie_block4">
   <div class="sx_rookie_channels">
       <ul>
          ...
          <li>
             <h2>VIP投资</h2>
             <p class="sx_baseMoney"><b>20,000元起</b></p>
             <h3>项目</h3>
             <p>1.金额大</p>
             <p>2.独享VIP投资</p>
          </li>
  ...
  <div class="sx_rookie_block5">
     ...
     <div class="sx_rookie_qbox">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="sx_rookie_tab">
          ...
          <tr>
            <td><span>会员特权：</span></td>
            <td>有机会参与平台重大投资；可优先预约标；可优先转让债权；配套客户经理；享用自动投标专权；专享理财顾问；企业总裁/平台首席投资顾问单独沟通机会。</td>
            <td>&nbsp;</td>
            <td></td>
            <td></td>
          </tr>
