...
<html>
<head>
<title><%=ArticleType.PTZH.getName()%></title>
	...
	<div class="contain clearfix">
		<div class="lead">
			...
			<%
				...
				PagingResult<T5011> result = articleManage.search(T5011_F02.PTZH,new Paging(){public int getCurrentPage(){return 1;}public int getSize(){return 5;}});
