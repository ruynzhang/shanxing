...
<div id="sx_m_main">   
   <form action="<%=configureProvider.format(URLVariable.M_REGISTER_SUBMIT)%>" method="get">	
    <div class="sx_m_block4" id="sx_reg">
        ...
        <%{String errorMessage = controller.getPrompt(request,response,PromptLevel.ERROR);if (!StringHelper.isEmpty(errorMessage)) {%>
          ...
          <li><input type="text" id="code" name="code" placeholder="推广码" maxlength="11" value="<%StringHelper.filterQuoter(out, request.getParameter("code"));%>" class="sx_input"/></li>
