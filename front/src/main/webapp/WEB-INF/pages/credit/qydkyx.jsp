	...
	<div class="w1002 pt30">
        ...
        <div class="jk_li">
            ...
            <li>
                ...
                <div class="mt10"><input name="" type="text" class="sx_inp" value=""/></div>
		<div class="mt15">借款类型<span class="ml20"><input name="daikuanway" type="radio" onclick="jk(2)" value="" class="mr5" />个人</span><span class="ml15"><input checked="checked" name="daikuanway" type="radio"  value="" class="mr5" />企业</span></div>
                <div class="mt15"><span style="margin-left:28px;">性别</span><span class="ml20"><input name="sex" type="radio" value="" class="mr5" checked="checked"/>男</span><span class="ml15"><input  name="sex" type="radio" value="" class="mr5" />女</span></div>
            ...
            <li class="middle">
                ...
                <div>企业名称</div>
                <div class="mt10">
                  <input name="F03" type="text" class="required sx_inp" maxlength="64" />
                  <p tip></p>
			      <p errortip class="" style="display: none"></p>
                </div>
                <div class="mt15">注册号</div>
                <div class="mt10">
                   <input name="F04" type="text" class="required sx_inp" />
                 <p tip></p>
			    <p errortip class="" style="display: none"></p>
                </div>
                <div class="mt15">联系人</div>
                <div class="mt10">
                  <input name="F05" type="text" class="required sx_inp" maxlength="64"/>
                  <p tip>不超过32个字</p>
			      <p errortip class="" style="display: none"></p>
                </div>
                <div class="mt15">手机号码</div>
                  <div class="mt10">
                     <input name="F06" type="text" class="required sx_inp" />
                     <p tip></p>
			         <p errortip class="" style="display: none"></p>
                  </div>
                  <div class="mt15">公司地址</div>
                  <div class="mt10">
                     <input name="F08" type="text" class="put01 required sx_inp" />
                     <p tip></p>
			         <p errortip class="" style="display: none"></p>
                  </div>
            </li>
            <li style="margin-right:0">
            	...
            	<div>意向借款金额(元)</div>
                  <div class="mt10">
                     <input name="F09" type="text" class="required sx_inp" />
                     <p tip></p>
			         <p errortip class="" style="display: none"></p>
                  </div>
                <div class="mt15">借款类型</div>
                <div class="mt10">
                  <input type="checkbox" name="F18" class="mr5" value="S"/>抵押
                  <input type="checkbox" name="F19" class="mr5" value="S"/>实地认证
                  <input type="checkbox" name="F20" class="mr5" value="S"/>担保
				</div>
                <div class="mt15">所在城市</div>
                <div class="mt10">
                  <select name="sheng" style="width:83px;" class="sx_inp2"></select> 
				<select name="shi" style="width:83px;" class="sx_inp2"></select>
				<select name="xian" style="width:83px;" class="required sx_inp2"></select>
				  <p tip></p>
			      <p errortip class="" style="display: none"></p>
                </div>
                <div class="mt15">预期筹款期限</div>
                <div class="mt10">
                  <select name="F09" class="sx_inp2" style="width:260px;">
                ...
                <div class="mt10">
                  <textarea name="F10" cols="" rows="" style="height:90px;" class="required sx_inp" placeholder="输入20-500个字"></textarea>
		  <p tip>输入20-500个字</p>
			      <p errortip class="" style="display: none"></p>
                </div>
            </li>
...
<div style="background:#e3e3e3; padding-top:0" class="all100">
  <div class="w1002 pt30">
        ...
        <div class="jk_problem">
            ...
            <div class="ico_da">由于善行创投的性质属于为投资人与融资方搭建提供保障服务的平台，其核心竞争力还是控制风险的能力，为让自身的本金保障承诺具备可行性，更 好的控制资金风险，我们目前只受理广东本地三个区的借款申请，后期将根据业务发展情况，在其他城市开发借款服务，请关注公告。</div>
            </li>
            <li class="jk_sx_pl">
    ...
    <div class="clear"></div>
		...
		<a href="<%configureProvider.format(out,URLVariable.CREDIT_DKYX);%>#sx_load_info"><span id="dkyxBtn"></span></a>
</div>
<!--相关问题答疑-->
