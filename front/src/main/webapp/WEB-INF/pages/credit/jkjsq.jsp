					...
					<div style="width: 700px; margin: 0 auto;">
						<ul class="electric clearfix">
							<li>
								...
								<div>
									<input name="" type="text" class="text jejs required isint mulriple-<%=configureProvider.format(SystemVariable.AUTO_BIDING_MULT_AMOUNT)%> min-size-<%=configureProvider.format(SystemVariable.AUTO_BIDING_MIN_AMOUNT)%>" maxlength="15" />
									<p tip>最低金额<%=configureProvider.format(SystemVariable.AUTO_BIDING_MIN_AMOUNT)%>,且为100的倍数</p>
									<p errortip class="" style="display: none"></p>
								</div>
							</li>
							<li style="width:350px;">
								<div class="list_w" style="width:60px;float:left;">年利率：</div>
								<div>
									<input name="rating" type="text" class="text required minf-size-10 maxf-size-24 jejs"  mtest="/^\d+(\d|(\.[1-9]{1}))$/" mtestmsg="只能有一位小数"  value="0"/>%
						...
						<div class="elect_btn tc">
							<input type="button" class="big_btn big_btn01 f16 jsqks sumbitForme" fromname="form1" value="开始计算" />
						</div>
					</div>
					<div class="elect_info" style="display: none;" id="showjs">
						<p class="pt20 pb20 f18">借款描述</p>
						<table width="85%" border="0" cellspacing="0" class="level_table">
							...
							<tr>
								<td>您将在<span class="red mr5 ml5 f18" id="mthns">0</span>个月后还清借款
								</td>
							</tr>

						</table>
						<p class="pt20 pb20 f18">本息偿还时间表</p>
