<!DOCTYPE HTML>
<%@page import="com.dimeng.p2p.front.servlets.Mpwd2"%>
<html>
<head>
...
<div id="sx_m_main">
    <div class="m_pwd_step">
       <ul>
         ...
         <li><div class="pwd_s ns">2</div><p>2.重设密码</p></li>
         <li><div class="pwd_s">3</div><p>3.成功</p></li>
       </ul>
       <div class="pwd_line1" style="width:49%;"></div>
       <div class="pwd_line2"></div>
    </div>
    <form action="<%=controller.getURI(request, Mpwd2.class)%>" method="get">
       ...
       <input type="hidden" name="PID" value="<%=request.getParameter("PID")%>"/>
        ...
        <ul>
         <%{String errorMessage = controller.getPrompt(request,response,PromptLevel.ERROR);if (!StringHelper.isEmpty(errorMessage)) {%>
          ...
          <%}}%>
          <li><input type="text" name="code" id="code" placeholder="输入校验码" class="sx_input"/>
          <li><input type="password" name="password" id="password" placeholder="输入新密码" class="sx_input"/>
          <li><input type="password" name="repassword" id="repassword" placeholder="再次输入新密码" class="sx_input"></li>
