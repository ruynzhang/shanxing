...
<div class="contain clearfix">
	<div class="about">
        ...
        <div class="public_detail" style="text-align:center;">
         <span style="float:left; font-size:16px;"><a class="blueLink" href="/zxdt/wdhyzx/<%=request.getParameter("currentPage") == null? 1 : request.getParameter("currentPage")%>">返回列表</a></span>
        ...
        <div class="info_cont detail">
			...
			<p>来源：<%if(article != null)StringHelper.filterHTML(out, article.F07); %></p>
				<%
			  // 上一篇和下一篇
			   T5011  befor5011 = articleManage.selectBeforT5011(T5011_F02.WDHYZX.name(),article.F04,article.F11);
			   T5011  next5011 =articleManage.selectAfterT5011(T5011_F02.WDHYZX.name(),article.F04,article.F11);	
		    %>
			<p align="center">
			<%if(befor5011!=null){ %>
			上一篇:&nbsp;<a class="blueLink" href="<%=controller.getPagingItemURI(request, Wdhyzx.class,befor5011.F01)%>"><%=befor5011.F06 %></a><%} %>&nbsp;
		   <%if(next5011!=null){ %>
		            下一篇:&nbsp;<a class="blueLink" href="<%=controller.getPagingItemURI(request, Wdhyzx.class,next5011.F01)%>"><%=next5011.F06 %></a><%} %></p>
         </div>
       </div>
   </div>
</div>
