...
'<div class="top">'+
   ...
   '<a class="close" style="font-size: 25px;color:#009ae2;opacity: 1;" href="javascript:void(0);">×</a>'+
   ' </div>'+
   ' <div class="tip"></div>'+
   ' <ul class="cal">'+
   ...
   ' <li><span class="l">年化收益率：</span><span class="r"><input class="txt" type="text"  data-in="/^\\d*\\.{0,1}(\\d{1,2})?$/" maxlength="5" value="13"/><i>%</i></span></li>'+
    '<li><span class="l">还 款 方 式：</span><select><option value="3">按月本息到期一次付清</option><option value="0">按天本息到期一次付清</option><option value="4">等额本息</option><option value="2">先息后本</option></select></li>'+
   ' <li><span class="l">项 目 期 限：</span><span class="r"><input class="txt" type="text"  data-in="/^\\d*$/" maxlength="3" value="1"/><i>月</i></span></li>'+
    '<li><span class="l">&nbsp;</span><a class="tocal" style="background: #009ae2;" href="javascript:;">计算</a><a class="tores" href="javascript:;">重置</a>'+
   '</li>'+
   '</ul>'+
'<h5>结 果 描 述：</h5>'+
				...
				$(".lay-cal .tocal").click(function(){
					...
					switch(type){
						...
						case "4"://等额本息
							...
							$(".lay-cal .tal:eq(2)").addClass("cur").html("每月应收本息：<span>"+contUn(Number(month).toFixed(2))+"</span>元");
						break;
						case "2"://先息后本
							month=parseFloat(amout*rate/100/12).toFixed(2);
							interest=parseFloat(amout*rate/100*time/12).toFixed(2);
							total=parseFloat(interest)+parseFloat(amout);
							last=time>1?(amout*1+interest*1)-parseFloat(month*(time*1-1)):amout*1+interest*1;
							$(".lay-cal .tal:eq(2)").addClass("cur").html("每月应收利息：<span>"+contUn(Number(month).toFixed(2))+"</span>元");
							$(".lay-cal .tal:eq(3)").addClass("cur").find("span").html(contUn(Number(last).toFixed(2)));
						break;
					}
					$(".lay-cal .tal:eq(0)").addClass("cur").find("span").html(contUn(Number(total)));
					$(".lay-cal .tal:eq(1)").addClass("cur").find("span").html(contUn(Number(interest)));
				});
