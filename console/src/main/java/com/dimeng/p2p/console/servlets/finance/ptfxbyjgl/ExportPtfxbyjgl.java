...
@Right(id = "P2P_C_FINANCE_EXPORTPTFXBYJ", name = "平台风险备用金导出")
public class ExportPtfxbyjgl extends AbstractFinanceServlet {
	...
	protected void processPost(final HttpServletRequest request,
		...
		ptfxbyjManage.export(result.getItems(), response.getOutputStream(), "");
	}
}
