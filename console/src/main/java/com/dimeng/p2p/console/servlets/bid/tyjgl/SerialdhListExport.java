...
@Right(id = "P2P_C_BUSI_SERIALDHLISTEXPORT", name = "序号兑换列表导出")
public class SerialdhListExport extends AbstractBidServlet {
	...
	protected void processPost(final HttpServletRequest request,
		...
		ExpemoneyCode[] list =bidManage.seproemoncode(new TyjselcodeQuery(){
		  ...
		  bidManage.exporExposerial(list, response.getOutputStream(), "GBK");
	}
}
