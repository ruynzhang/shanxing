package com.dimeng.p2p.console.servlets.account.qyxx.lxxx;
...
import com.dimeng.p2p.console.servlets.account.qyxx.ccxx.ListCcxx;
import com.dimeng.p2p.modules.account.console.service.QyManage;
import com.dimeng.util.parser.IntegerParser;

@Right(id = "P2P_C_ACCOUNT_QYXX_UPDATELXXX",  name = "企业联系信息修改")
