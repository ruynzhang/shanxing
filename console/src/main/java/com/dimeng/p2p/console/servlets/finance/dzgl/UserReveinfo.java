...
@Right(id = "P2P_C_FINANCE_USERREVEINFO", isMenu = true, name = "用户收益明细")
public class UserReveinfo extends AbstractDzglServlet {
	...
	protected void processPost(final  HttpServletRequest request,
		...
		PagingResult<UserReveentity> result =playManage.SetUserrevePage(new TyjselcodeQuery(){
			@Override
