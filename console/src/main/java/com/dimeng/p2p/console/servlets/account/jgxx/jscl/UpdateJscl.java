package com.dimeng.p2p.console.servlets.account.jgxx.jscl;
...
import com.dimeng.p2p.console.servlets.account.jgxx.cwzk.UpdateCwzk;
import com.dimeng.p2p.modules.account.console.service.QyManage;
import com.dimeng.util.parser.IntegerParser;

@Right(id = "P2P_C_ACCOUNT_JGXX_UPDATEJSCL",  name = "机构介绍资料修改")
