...
@Right(id = "P2P_C_FINANCE_TYJINTERESTLISTEXPORT", name = "体验金审核导出")
public class TyjInterestListExport extends AbstractFinanceServlet {
	...
	protected void processPost(final HttpServletRequest request,
		...
		ExpemonyInte[] list=bidManage.seTyjInterestbefoExpor(new TyjselcodeQuery(){
			@Override
		 ...
		 bidManage.exporExpemonyInte(list, response.getOutputStream(), "GBK");
	}
}
