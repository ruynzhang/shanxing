...
import com.dimeng.p2p.modules.bid.console.service.entity.ExpemonyShen;
import com.dimeng.p2p.modules.bid.console.service.query.TyjselcodeQuery;
import com.dimeng.util.parser.IntegerParser;
import com.dimeng.util.parser.TimestampParser;

@Right(id = "P2P_C_FINANCE_TYJSHNEWLIST", isMenu = true, name = "体验金审核")
public class TyjshList extends AbstractFinanceServlet {
	...
	protected void processPost(final HttpServletRequest request,
		...
		//借款总金额
		BigDecimal bosummoeny = bidManage.getboSumMoney();
		//放款总金额
		BigDecimal fosummoney = bidManage.getfkSumMoney();
		
		
		
		
		PagingResult<ExpemonyShen> result =bidManage.SeleTyjshPage(new TyjselcodeQuery(){
			@Override
		...
		request.setAttribute("bosummoeny", bosummoeny);
		request.setAttribute("fosummoney", fosummoney);
