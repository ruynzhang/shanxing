...
@Right(id = "P2P_C_FINANCE_EXPORTYBCJRECORD", name = "放款成交记录导出")
public class ExportTybcjRecord extends AbstractFinanceServlet {
	...
	protected void processPost(final HttpServletRequest request,
		...
		fkshManage.exporttybcj(result.getItems(), response.getOutputStream(), "");
	}
}
