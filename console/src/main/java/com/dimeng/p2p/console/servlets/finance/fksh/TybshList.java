...
@Right(id = "P2P_C_FINANCE_TYBSHLIST", isMenu = true, name = "体验标审核")
public class TybshList extends AbstractFinanceServlet {
	...
	protected void processPost(final HttpServletRequest request,
		...
		PagingResult<Expemonyinfo> result = fkshManage.searchTyjload(new FkshQuery(){
			@Override
