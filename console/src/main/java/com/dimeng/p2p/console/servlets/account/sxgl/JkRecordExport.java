...
@Right(id = "P2P_C_ACCOUNT_JKRECORDEXPORT", name = "导出借款记录")
public class JkRecordExport extends AbstractAccountServlet {
	...
	protected void processPost(final HttpServletRequest request,
		...
		JkRecordVO[] vos=manage.JkRecordList(query);
		manage.exportJkRecord(vos, response.getOutputStream()); //导出数据
	}
}
