...
@Right(id = "P2P_C_FINANCE_PLAYBIDINFO", isMenu = true, name = "标的支出表")
public class PlayBidinfo extends AbstractDzglServlet {
	...
	protected void processPost(final  HttpServletRequest request,
		...
		PagingResult<PlayBidentity> result =playManage.SetPlaybidPage(new TyjselcodeQuery(){
			@Override
