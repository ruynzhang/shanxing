...
@Right(id = "P2P_C_FINANCE_TYJSHNEWLISTEXPORT", name = "体验金审核导出")
public class TyjshListExport extends AbstractFinanceServlet {
	...
	protected void processPost(final HttpServletRequest request,
		...
		ExpemonyShen[] list=bidManage.seExpemonyshExpor(new TyjselcodeQuery(){
			@Override
		 ...
		 bidManage.exporExpemonyShen(list, response.getOutputStream(), "GBK");
	}
}
