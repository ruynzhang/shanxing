...
<%@page import="com.dimeng.p2p.console.servlets.finance.order.FKOrderDZServlet"%>
<html>
<head>
	...
	<div class="w_main">
		<div class="main clearfix">
			<div class="wrap">
				<div class="r_main">
					<div class="home_main">
						<form action="<%controller.getURI(request, FKOrderList.class);%>" method="post" name="form1" id="searchForm">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="3" class="yhgl_table tc">
								...
								<tr class="dhsbg">
									...
									<td><a href="<%=controller.getURI(request, FKOrderDZServlet.class)%>?orderId=<%=order.F01%>" target="blank">去对账</a></td>	
								</tr>
								<%
									}
								}
