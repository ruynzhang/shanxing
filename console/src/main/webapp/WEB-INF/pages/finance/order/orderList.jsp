	...
	<div class="w_main">
		<div class="main clearfix">
			<div class="wrap">
				<div class="r_main">
					<div class="home_main">
						<form action="<%controller.getURI(request, OrderList.class);%>" method="post" name="form1" id="searchForm">
											...
											<p>
												...
												<select name="type">
													...
													<%
														...
														{
													%>
													<option value="<%=orderType.orderType()%>" <%if (orderType.orderType()==IntegerParser.parse(request.getParameter("type"))){%> selected="selected" <%} %>><%=orderType.getChineseName() %></option>
													<%} %>
												</select>
											</p>
											<P>
