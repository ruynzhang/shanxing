...
<body>
	...
	<div class="w_main">
		<div class="main clearfix">
			<div class="wrap">
				<div class="r_main">
				<form action="<%=controller.getURI(request, Shtg.class)%>" method="post" id="searchForm" name="form1">
					<div class="home_main">
							...
							<div class="til clearfix">
								<div class="Menubox">
									<ul>
										...
										<li id="one2" class="hover">审核通过</li>
								...
								<div class="border p15 Men_bt no_table" id="con_one_1">
									<table width="100%" border="0" cellspacing="0" cellpadding="0" class="yhgl_table tc">
										...
										<tr class="dhsbg">
											...
											<td><%=Formater.formatDateTime(txglItem.F11)%></td>
											...
											%>
											<a href="<%=controller.getURI(request, CheckWithdraw.class)%>?id=<%=txglItem.F01%>">放款</a>
											<%}else{ %>
	...
	<script type="text/javascript">
		function showExport()
		{
			document.getElementById("searchForm").action ="<%=controller.getURI(request, ExportTxgl.class)%>";
			$("#searchForm").submit();
