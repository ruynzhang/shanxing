...
<body>
	...
	<div class="w_main">
		<div class="main clearfix">
			<div class="wrap">
				<div class="r_main">
					<form action="<%=controller.getURI(request, TxglList.class)%>" method="post" id="searchForm" name="form1">
					<div class="home_main">
							...
							<div class="con">
								<div class="admin_input admin_pb">
             						<div class="table top3">
										...
										<P><input name="search" type="submit" class="btn2" value="搜索" /></P>
								...
								<div class="border p15 Men_bt no_table" id="con_one_1">
									<table width="100%" border="0" cellspacing="0" cellpadding="0" class="yhgl_table tc">
										...
										<tr class="dhsbg">
											...
											%>
											<a href="<%=controller.getURI(request, Check.class)%>?id=<%=txglItem.F01%>">审核</a>
											<%}else{ %>
											<span class="gray6">审核</span>
											<%} %> 
											</td>
										</tr>
										<%
