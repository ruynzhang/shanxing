...
<body>
	...
	<div class="w_main">
		<div class="main clearfix">
			<div class="wrap">
				<div class="r_main">
					<form action="<%=controller.getURI(request, Check.class)%>" method="post" id="form1">
								...
								<div class="con">
									...
									<ul class="cell noborder yw_jcxx">
										...
										<li>
											<div class="til">&nbsp;</div>
											<div class="info">	
												<textarea cols="50" rows="6" id="reason" name="check_reason"  onKeyUp="limitTextArea(this,50)" onkeypress="limitTextArea(this,50)">如不通过需填写具体原因</textarea>
											</div>
											<div class="clear"></div>
										</li>
									...
									<div class="tc pt20" style="width:360px;margin:auto">
										<a href="javascript:void(0)" onclick="check('<%=T6130_F09.DFK.name()%>')" class="btn3 mr10">通过</a> 
										<a href="javascript:void(0)" onclick="check('<%=T6130_F09.TXSB.name()%>')" class="btn3 mr10">不通过</a>
										 <a href="<%=controller.getURI(request, TxglList.class)%>" class="btn5 mr30">取消</a>
									</div>
									<div class="clear"></div>
								</div>
							</div>
