					...
					<div class="home_main">
						...
						<div class="newsbox">
							<div class="til clearfix">
								<a href="<%=request.getParameter("url") == null?controller.getURI(request, FkshList.class):request.getParameter("url")%>"
