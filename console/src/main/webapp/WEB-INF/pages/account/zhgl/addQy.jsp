            	...
            	<div class="box box1">
                    ...
                    <li>
                       ...
                       <li>
                        ...
                        <div class="info">
                        	<input name="F06" maxlength="10"  type="text" class="text yhgl_ser required max-length-9 min-length-9" value="<%StringHelper.filterHTML(out, request.getParameter("F06"));%>" />
                        	<p tip></p>
							<p errortip class="" style="display: none"></p>
                        </div>
                        <div class="clear"></div>
                        ...
                        <div class="info">
                        	<input name="F08" maxlength="15" mtest="/^((([1-9][0-9]*)|0)|((([1-9][0-9]*)|0)\.[0-9]{1,2}))$/" mtestmsg="必须为数字格式(且是两位小数)"  type="text" class="text yhgl_ser" value="<%StringHelper.filterHTML(out, request.getParameter("F08"));%>" />万元
                        	<p tip></p>
							<p errortip class="" style="display: none"></p>
                        </div>
                        <div class="clear"></div>
                        ...
                        <div class="info">
                        	<input name="F10" maxlength="18" minlength="15"  type="text" class="text yhgl_ser required isint" value="<%StringHelper.filterHTML(out, request.getParameter("F10"));%>" />人
                        	<p tip></p>
							<p errortip class="" style="display: none"></p>
                        </div>
                        <div class="clear"></div>
                      ...
                      <li>
                        ...
                        <div class="info">
                        	<input name="F14" maxlength="15" mtest="/^((([1-9][0-9]*)|0)|((([1-9][0-9]*)|0)\.[0-9]{1,2}))$/" mtestmsg="必须为数字格式(且是两位小数)"  type="text" class="text yhgl_ser" value="<%StringHelper.filterHTML(out, request.getParameter("F14"));%>" />万元
                        	<p tip></p>
							<p errortip class="" style="display: none"></p>
                        </div>
                        <div class="clear"></div>
                    ...
                    <li>
                        ...
                        <div class="info">
                        	<input name="F15" maxlength="15" mtest="/^((([1-9][0-9]*)|0)|((([1-9][0-9]*)|0)\.[0-9]{1,2}))$/" mtestmsg="必须为数字格式(且是两位小数)"  type="text" class="text yhgl_ser" value="<%StringHelper.filterHTML(out, request.getParameter("F15"));%>" />万元
                        	<p tip></p>
							<p errortip class="" style="display: none"></p>
                        </div>
                        <div class="clear"></div>
                    ...
                    <li>
                        ...
                        <div class="info">
                        	<input name="F16" maxlength="50"  type="text" class="text yhgl_ser" value="<%StringHelper.filterHTML(out, request.getParameter("F16"));%>" />
                        </div>
                        <div class="clear"></div>
                    </li>
                    <li>
                        ...
                        <div class="info">
                        	<input name="F17" maxlength="50"  type="text" class="text yhgl_ser" value="<%StringHelper.filterHTML(out, request.getParameter("F17"));%>" />
                        </div>
                        <div class="clear"></div>
                    </li>
                     <li>
