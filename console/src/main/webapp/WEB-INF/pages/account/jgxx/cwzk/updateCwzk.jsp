									...
									<div>
										<table width="100%" border="0" cellspacing="0" cellpadding="3"
											...
											<tr>
												...
												<td><input name="t6163s[<%=i%>].F03" mtest="/^((([1-9][0-9]*)|0)|((([1-9][0-9]*)|0)\.[0-9]{1,2}))$/" mtestmsg="必须为数字" type="text" maxlength="18"
													class="text yhgl_ser w100 required" value="<%=entity.F03 %>" />
													<p tip></p>
													<p errortip class="" style="display: none"></p>	
												</td>
												<td><input name="t6163s[<%=i%>].F05" mtest="/^((([1-9][0-9]*)|0)|((([1-9][0-9]*)|0)\.[0-9]{1,2}))$/" mtestmsg="必须为数字" type="text" maxlength="18"
													class="text yhgl_ser w100 required" value="<%=entity.F05 %>" />
													<p tip></p>
													<p errortip class="" style="display: none"></p>	
												</td>
												<td><input name="t6163s[<%=i%>].F06" mtest="/^((([1-9][0-9]*)|0)|((([1-9][0-9]*)|0)\.[0-9]{1,2}))$/" mtestmsg="必须为数字" type="text" maxlength="18"
													class="text yhgl_ser w100 required" value="<%=entity.F06 %>" />
													<p tip></p>
													<p errortip class="" style="display: none"></p>	
												</td>
												<td><input name="t6163s[<%=i%>].F07" mtest="/^((([1-9][0-9]*)|0)|((([1-9][0-9]*)|0)\.[0-9]{1,2}))$/" mtestmsg="必须为数字" type="text" maxlength="18"
													class="text yhgl_ser w100 required"   value="<%=entity.F07 %>" />
													<p tip></p>
													<p errortip class="" style="display: none"></p>	
												</td>
												<td><input name="t6163s[<%=i%>].F08" type="text" maxlength="200"
													class="text yhgl_ser w100 required" value="<%StringHelper.filterHTML(out, entity.F08); %>" />
													<p tip></p>
													<p errortip class="" style="display: none"></p>	
												</td>
											</tr>
