			...
			<div class="wrap">
				<div class="r_main">
                    ...
                    <li>
                        ...
                        <div class="info"><%StringHelper.filterHTML(out, entity.F18); %></div>
                        <div class="clear"></div>
                    </li>
                    <li>
                       ...
                       <li>
                        ...
                        <div class="info"><%=entity.F07%>年</div>
                        <div class="clear"></div>
                    </li>
                    ...
                    <li>
                        ...
                        <div class="info"><%StringHelper.format(out, entity.jgjs, fileStore); %></div>
                        <div class="clear"></div>
                    </li>
					<li>
						<div class="clear"></div>
