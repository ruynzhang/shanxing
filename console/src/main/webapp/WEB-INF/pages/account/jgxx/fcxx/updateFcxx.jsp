...
<%@page import="com.dimeng.p2p.console.servlets.account.jgxx.fcxx.UpdateFcxx"%>
            ...
            <div class="home_main">
                ...
                <div class="til clearfix">
                  ...
                  <div class="border p30 Men_bt no_table">
                    ...
                    <form action="<%=controller.getURI(request, UpdateFcxx.class)%>?id=<%StringHelper.filterHTML(out, request.getParameter("userId"));%>&paging.current=<%=request.getParameter("paging.current") %>" method="post" class="form1">
                   ...
                   <li>
                        ...
                        <div class="info">
                        		<input name="F04" maxlength="20" type="text" class="text yhgl_ser required" value="<%=entity.F04 %>" />平方米
                        	<p tip></p>
							<p errortip class="" style="display: none"></p>
                        </div>
                        <div class="clear"></div>
                     ...
                     <li>
                        ...
                        <div class="info">
                        	<input name="F06"  maxlength="15" mtest="/^((([1-9][0-9]*)|0)|((([1-9][0-9]*)|0)\.[0-9]{1,2}))$/" mtestmsg="必须为数字格式(且是两位小数)" type="text" class="text yhgl_ser required" value="<%=entity.F06 %>" />万元
                        	<p tip></p>
							<p errortip class="" style="display: none"></p>
                        </div>
                        <div class="clear"></div>
                    ...
                    <li>
                        ...
                        <div class="info">
                        	<input name="F07"  maxlength="15" mtest="/^((([1-9][0-9]*)|0)|((([1-9][0-9]*)|0)\.[0-9]{1,2}))$/" mtestmsg="必须为数字格式(且是两位小数)" type="text" class="text yhgl_ser required" value="<%=entity.F07 %>" />万元
                        	<p tip></p>
							<p errortip class="" style="display: none"></p>
                        </div>
                        <div class="clear"></div>
                     ...
                     <li>
                        ...
                        <div class="info">
                        	<input name="F09" maxlength="40" type="text" class="text yhgl_ser required" value="<%StringHelper.filterHTML(out, entity.F09); %>" />
                        	<p tip></p>
							<p errortip class="" style="display: none"></p>
                        </div>
                        <div class="clear"></div>
                     ...
                     <li>
                        ...
                        <div class="info">
                        	<input name="F10" maxlength="20" type="text" class="text yhgl_ser required" value="<%StringHelper.filterHTML(out, entity.F10); %>" />
                        	<p tip></p>
							<p errortip class="" style="display: none"></p>
                        </div>
                        <div class="clear"></div>
                     ...
                     <li>
                        ...
                        <div class="info">
                        	<input name="F11"  maxlength="15" mtest="/^((([1-9][0-9]*)|0)|((([1-9][0-9]*)|0)\.[0-9]{1,2}))$/" mtestmsg="必须为数字格式(且是两位小数)" type="text" class="text yhgl_ser required" value="<%=entity.F11 %>" />万元
                        	<p tip></p>
							<p errortip class="" style="display: none"></p>
                        </div>
                        <div class="clear"></div>
                    ...
                    <div class="tc w220">
                    	...
                    	<input type="button" class="btn4" onclick="window.location.href='<%=controller.getURI(request, ListFcxx.class)%>?id=<%StringHelper.filterHTML(out, request.getParameter("userId"));%>&paging.current=<%=request.getParameter("paging.current") %>'" value="返回" /></div>
                    <div class="clear"></div>
                    </form>                  
                    </div>
            	<div class="mb15"></div>
