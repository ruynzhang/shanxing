        ...
        <div class="r_main">
            <div class="home_main">
                ...
                <div class="newsbox">
                  <div class="til clearfix">
                   <div class="Menubox">
                     <ul>
                        ...
                        <li id="one3" class="hover">可选认证（<%=kxrztg%>/<%=basicInfo.notNeedAttestation%>）</li>
                  ...
                  <div class="border p15 Men_bt no_table" id="con_one_3">
                      ...
                      <tr class="bom">
                        ...
                        <td align="center"><%=need.attestationState.getChineseName()%></td>
                        <td align="center"><%=TimestampParser.format(need.attestationTime)%></td>
                        <td align="center"><%=need.creditGrades%></td>
                        ...
                        %>
                        		<a href="<%=controller.getURI(request,Open.class)%>?id=<%=id%>">查看证件&nbsp;<%=a+1 %>&nbsp;</a>
                        <%}} %>
                        	</td>
                        <%}else{ %>
