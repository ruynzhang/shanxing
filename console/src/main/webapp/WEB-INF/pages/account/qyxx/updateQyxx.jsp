            ...
            <div class="home_main">
                ...
                <div class="til clearfix">
                  ...
                  <div class="border p30 Men_bt no_table">
                    <form action="<%=controller.getURI(request, UpdateQyxx.class)%>" method="post" class="form1">
                   ...
                   <ul class="cell noborder yxjh ">
                    ...
                    <li>
                       ...
                       <li>
                        ...
                        <div class="info">
                        	<input name="F08" maxlength="15" mtest="/^((([1-9][0-9]*)|0)|((([1-9][0-9]*)|0)\.[0-9]{1,2}))$/" mtestmsg="必须为数字格式(且是两位小数)"  type="text" class="text yhgl_ser" value="<%=entity.F08%>" />万元
                        	<p tip></p>
							<p errortip class="" style="display: none"></p>
                        </div>
                        <div class="clear"></div>
                       ...
                       <li>
                        ...
                        <div class="info">
                        	<input name="F12" maxlength="50"  type="text" class="text yhgl_ser required idcard" value="<%StringHelper.filterHTML(out,StringHelper.decode(entity.F13));%>" />
                        	<p tip></p>
							<p errortip class="" style="display: none"></p>
                        </div>
                        <div class="clear"></div>
                    ...
                    <li>
                        ...
                        <div class="info">
                        	<input name="F16" maxlength="50"  type="text" class="text yhgl_ser" value="<%StringHelper.filterHTML(out,  entity.F16);%>" />
                        </div>
                        <div class="clear"></div>
                    </li>
                    <li>
                        ...
                        <div class="info">
                        	<input name="F17" maxlength="50"  type="text" class="text yhgl_ser" value="<%StringHelper.filterHTML(out,  entity.F17);%>" />
                        </div>
                        <div class="clear"></div>
                    </li>
                    <li>
