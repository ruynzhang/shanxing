...
<%@page import="com.dimeng.p2p.console.servlets.account.qyxx.JbxxView"%>
        ...
        <div class="r_main">
            <div class="home_main">
            	...
            	<div class="box box1 mb15">
                    ...
                    <div class="con">
                    	  <div class="admin_input admin_pb">
                                <p>企业名称：<input type="text" name="userName" value="<%StringHelper.filterHTML(out, request.getParameter("userName"));%>" class="yhgl_input mr5" /></p>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="3" class="yhgl_table tc">
                        ...
                        <%
                        	if (enterpriseArray != null) {for (int i =0;i<enterpriseArray.length;i++){Enterprise enterprise=enterpriseArray[i];if (enterprise == null) {continue;}
                        %>
                        <tr class="dhsbg">
                          <td><%=i+1%></td>
                          ...
                          <td><%StringHelper.filterHTML(out, enterprise.F09);%></td>
                          <td><%=TimestampParser.format(enterprise.F07)%></td>
                           <td><%=enterprise.F06.getChineseName()%></td>
                          <td>
                          	<span class="blue"><a href="<%=controller.getURI(request,ViewQyxx.class)%>?id=<%=enterprise.F01%>" class="mr10">查看</a></span>
                          	<%if (dimengSession.isAccessableResource(UpdateQyxx.class)) {%>
                          	<span class="blue"><a href="<%=controller.getURI(request,UpdateQyxx.class)%>?id=<%=enterprise.F01%>" class="mr10">修改</a></span>
                          	<%}else{ %>
