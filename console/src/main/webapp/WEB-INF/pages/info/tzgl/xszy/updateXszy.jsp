        ...
        <div class="r_main">
            <div class="home_main">
            	<div class="box box1 mb15">
                    ...
                    <div class="con">
                    <div class="clear"></div>
                    <form name="example" method="post" action="<%=controller.getURI(request, UpdateXszy.class)%>" class="form1" onsubmit="return onSubmit();">
                    ...
                    <li>
                        ...
                        <div class="info">
                        	<input type="text" class="text yhgl_ser yw_w4 required max-length-10" name="title" value="<%StringHelper.filterHTML(out, record.title);%>"/>
                        	<p tip>最大10个字符</p>
                     ...
                     <li>
                        ...
                        <div class="info orange">
                        	<input type="text" name="sortIndex" class="text yhgl_ser yw_w4  required isint max-length-10" value="<%=record.sortIndex %>"/>
                        	<p tip></p>
							<p errortip class="" style="display: none"></p>
                        </div>
                        <div class="clear"></div>
                    ...
                    <li>
                        ...
                        <div class="info">
                         <textarea name="content" cols="100" rows="8" style="width:700px;height:500px;visibility:hidden;"><%StringHelper.format(out, connent,fileStore);%></textarea>
                         <p id="errorContent">&nbsp;</p>
                        </div>
                        <div class="clear"></div>
                    </li>
