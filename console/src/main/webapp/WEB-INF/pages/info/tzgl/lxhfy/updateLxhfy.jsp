        ...
        <div class="r_main">
            <div class="home_main">
            	<div class="box box1 mb15">
                    ...
                    <div class="con">
                    <div class="clear"></div>
                    <form action="<%=controller.getURI(request, UpdateLxhfy.class)%>"  method="post" name="example" onsubmit="return onSubmit();">
                    ...
                    <li>
                        ...
                        <div class="info orange">
                        	<textarea name="content" cols="100" rows="8" style="width:700px;height:500px;visibility:hidden;"><%StringHelper.format(out, ObjectHelper.convert(request.getAttribute("content"), String.class),fileStore);%></textarea>
                        	<p id="errorContent">&nbsp;</p>
                        </div>
                        <div class="clear"></div>
                    </li>
