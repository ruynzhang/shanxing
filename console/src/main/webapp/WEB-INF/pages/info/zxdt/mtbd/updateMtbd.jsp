        ...
        <div class="r_main">
            <div class="home_main">
            	<div class="box box1 mb15">
                    ...
                    <div class="con">
                    <div class="clear"></div>
                    <form name="example" method="post" action="<%=controller.getURI(request, UpdateMtbd.class)%>" enctype="multipart/form-data" class="form1" onsubmit="return onSubmit();">
                    ...
                    <li>
                      ...
                      <li>
                        ...
                        <div class="info orange">
                        	<input type="text" class="text yhgl_ser yw_w4 max-length-50" name="source" value="<%StringHelper.filterHTML(out, record.source);%>"/>
                        	<p tip></p>
							<p errortip class="" style="display: none"></p>
                        </div>
                        <div class="clear"></div>
                     ...
                     <li>
                        ...
                        <div class="info orange">
                          <p class="mb10"><img src="<%=fileStore.getURL(record.imageCode) %>" width="277" height="89" /></p>
                        	<input type="file" class="text yhgl_ser yw_w4" name="image" value=""/>
                        </div>
                        <div class="clear"></div>
                    </li>
                      <li>
                    ...
                    <li>
                     ...
                     <li>
                        ...
                        <div class="info">
                        	<input type="text" class="text yhgl_ser yw_w4 max-length-110" name="summary" value="<%StringHelper.filterHTML(out, record.summary);%>"/>
                        	<p tip>最大110个字符</p>
							<p errortip class="" style="display: none"></p>
                        </div>
                        <div class="clear"></div>
                    ...
                    <a href="<%=controller.getURI(request, SearchMtbd.class) %>" class="btn4">返回</a>
                    </div>
                	<div class="clear"></div>
                    </form>
                    <div class="clear"></div>                    
