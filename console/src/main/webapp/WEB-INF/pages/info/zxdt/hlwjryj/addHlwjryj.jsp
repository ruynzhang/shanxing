        ...
        <div class="r_main">
            <div class="home_main">
            	<div class="box box1 mb15">
                    ...
                    <div class="con">
                    <div class="clear"></div>
                    <form name="example" method="post" action="<%=controller.getURI(request, AddHlwjryj.class)%>" class="form1" onsubmit="return onSubmit();">
                    ...
                    <li>
                     ...
                     <li>
                        ...
                        <div class="info orange">
                        	<input type="text" id="datepicker1" readonly="readonly" name="publishTime" class="text yhgl_ser yw_w4 required" value="<%StringHelper.filterHTML(out, request.getParameter("publishTime"));%>"/>
                        	<p tip></p>
                        	<p errortip class="" style="display: none"></p>
                        </div>
                        <div class="clear"></div>
