        ...
        <div class="r_main">
            <div class="home_main">
            	<div class="box box1 mb15">
                    ...
                    <div class="con">
                    <div class="clear"></div>
                    <form name="example" method="post" action="<%=controller.getURI(request, AddMtbd.class)%>" class="form1" enctype="multipart/form-data" onsubmit="return onSubmit();">
                    ...
                    <li>
                     ...
                     <li>
                        ...
                        <div class="info orange">
                        	<input type="file" class="text yhgl_ser yw_w4" name="image" value="<%StringHelper.filterHTML(out, request.getParameter("image"));%>"/><p id="errorImage">&nbsp;</p>
                        </div>
                        <div class="clear"></div>
                    </li>
                      <li>
