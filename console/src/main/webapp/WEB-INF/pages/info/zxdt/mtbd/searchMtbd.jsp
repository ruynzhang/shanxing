...
<div class="main clearfix">
	 ...
	 <form action="<%=controller.getURI(request, SearchMtbd.class)%>" method="post">
  	 <div class="wrap">
        <div class="r_main">
            <div class="home_main">
            	<div class="box box1 mb15">
                    ...
                    <div class="mt10">   
                    	...
                    	<%if (dimengSession.isAccessableResource(AddMtbd.class)) {%>
                   			<a href="<%=controller.getURI(request, AddMtbd.class)%>" class="btn3 mr10"><span class="ico3"></span>添加</a>
                   		<%}else{ %>
                        ...
                        <tr class="dhsbg">
                          ...
                          <td class="blue">
                          	<%if (dimengSession.isAccessableResource(UpdateMtbd.class)) {%>
                          		<a href="<%=controller.getURI(request, UpdateMtbd.class)%>?id=<%=record.id %>">修改</a>
                          	<%}else{ %>
								<span class="gray6">修改</span>
							<%} %> 
							<%if (dimengSession.isAccessableResource(DeleteMtbd.class)) {%>  
                          		<a href="<%=controller.getURI(request, DeleteMtbd.class)%>?id=<%=record.id %>">删除</a>
                          	<%}else{ %>
