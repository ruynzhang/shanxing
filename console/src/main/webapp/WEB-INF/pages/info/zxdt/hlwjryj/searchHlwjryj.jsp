...
<div class="main clearfix">
	 ...
	 <form action="<%=controller.getURI(request, SearchHlwjryj.class)%>" method="post">
  	 <div class="wrap">
        <div class="r_main">
            <div class="home_main">
                    ...
                    <span >
                     ...
                     <div class="mt10">
                   		...
                   		<%if (dimengSession.isAccessableResource(AddHlwjryj.class)) {%>
                     		<a href="<%=controller.getURI(request, AddHlwjryj.class)%>" class="btn3 mr10"><span class="ico3"></span>添加</a>
                     	<%}else{ %>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="3" class="yhgl_table tc">
                        ...
                        <tr class="dhsbg">
                          ...
                          <%if (dimengSession.isAccessableResource(UpdateHlwjryj.class)) {%>
                          	<a href="<%=controller.getURI(request, UpdateHlwjryj.class)%>?id=<%=record.id %>">修改</a>
                          <%}else{ %>
							<span class="gray6">修改</span>
						<%} %>  
                          <%if (dimengSession.isAccessableResource(DeleteHlwjryj.class)) {%> 
                          	<a href="<%=controller.getURI(request, DeleteHlwjryj.class)%>?id=<%=record.id %>">删除</a>
                          <%}else{ %>
