<%@page import="com.dimeng.p2p.console.servlets.info.yqlj.AddYqlj"%>
        ...
        <div class="r_main">
            <div class="home_main">
            	<div class="box box1 mb15">
                    ...
                    <div class="con">
                    <div class="clear"></div>
                    <form name="example" method="post" action="<%=controller.getURI(request, AddYqlj.class)%>" class="form1">
                    ...
                    <li>
                        ...
                        <div class="info orange">
                        	<input type="text" class="text yhgl_ser yw_w4 required" name="url" value="<%StringHelper.filterHTML(out,request.getParameter("url"));%>"/>
                        	<p tip></p>
							<p errortip class="" style="display: none"></p>
                        </div>
                        <div class="clear"></div>
                    ...
                    <a href="<%=controller.getURI(request, SearchYqlj.class) %>" class="btn4">返回</a></div>
                	<div class="clear"></div>
                    </form>
                    <div class="clear"></div>                    
                  </div>
