...
<%@page import="com.dimeng.p2p.console.servlets.info.gywm.gltd.*"%>
...
<div class="main clearfix">
	 ...
	 %>
	 <form action="<%=controller.getURI(request, SearchGltd.class)%>" method="post">
  	 <div class="wrap">
        <div class="r_main">
            <div class="home_main">
            	<div class="box box1 mb15">
                    ...
                    <p>
                    <span>团队名称：</span><span><input type="text" name="title" id="textfield" class="yhgl_input" value="<%StringHelper.filterHTML(out, request.getParameter("title"));%>"/></span>
                    </p>
                    <p>
                    ...
                    <%if (dimengSession.isAccessableResource(AddGltd.class)) {%>
                    	<a href="<%=controller.getURI(request, AddGltd.class)%>" class="btn3 mr10"><span class="ico3"></span>添加</a>
                    <%}else{ %>
                        ...
                        <tr class="dhsbg">
                          ...
                          <td class="blue">
                          	<%if (dimengSession.isAccessableResource(UpdateGltd.class)) {%>
                          		<a href="<%=controller.getURI(request, UpdateGltd.class)%>?id=<%=record.id %>">修改</a>
                          	<%}else{ %>
								<span class="gray6">修改</span>
							<%} %>   
							<%if (dimengSession.isAccessableResource(DeleteGltd.class)) {%>
                          		<a href="<%=controller.getURI(request, DeleteGltd.class)%>?id=<%=record.id %>">删除</a>
                          	<%}else{ %>
