        ...
        <div class="r_main">
            <div class="home_main">
            	<div class="box box1 mb15">
                    ...
                    %>
                    <form action="<%=controller.getURI(request, UpdateGsjj.class)%>"  method="post" name="example" onsubmit="return onSubmit();">
                    ...
                    <input type="submit" class="btn4 mr30" value="确认" /></div>
                	<div class="clear"></div>
                    </form>
                    <div class="clear"></div>                    
                  </div>
