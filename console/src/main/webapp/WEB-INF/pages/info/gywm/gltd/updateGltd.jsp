        ...
        <div class="r_main">
            <div class="home_main">
            	<div class="box box1 mb15">
                    ...
                    <div class="con">
                    <div class="clear"></div>
                    <form name="example" method="post" action="<%=controller.getURI(request, UpdateGltd.class)%>" enctype="multipart/form-data" class="form1">
                    ...
                    <li>
                     ...
                     <li>
                        ...
                        <div class="info orange">
                        <p class="mb10"><%if(record.imageCode !=null){ %><img src="<%=fileStore.getURL(record.imageCode) %>" width="277" height="89" /><%} %></p>
                        <input type="file" class="text yhgl_ser yw_w4" name="image"/></div>
                        <div class="clear"></div>
                    </li>
                    <li>
