...
<%@page import="com.dimeng.p2p.console.servlets.spread.ywygl.Add"%>
...
<div class="w_main">
  ...
  <div class="main clearfix">
   ...
   <form action="<%=controller.getURI(request, Add.class) %>" method="post" class="form1">
   <div class="wrap">
            	...
            	<div class="box box1 mb15">
                    ...
                    <ul class="cell noborder no_wi">
                     <li class="clearfix">
                        ...
                        <div class="info">
                          <input type="text" name="name" id="name" class="text yhgl_ser required max-length-10" />
                          <p tip></p>
                    ...
                    <li class="clearfix">
                        ...
                        <div class="info">
                        <input type="text" name="tel" id="tel" class="text yhgl_ser required phonenumber"/>
                        <p tip></p>
						<p errortip class="" style="display: none"></p>
						</div>
						<div class="clear"></div>
