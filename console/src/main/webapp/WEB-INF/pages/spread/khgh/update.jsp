						...
						<div class="box box1 mb15">
							...
							<div class="con">
								...
								<form name="example" method="post"
									action="<%=controller.getURI(request, Update.class)%>"
									class="form1" onsubmit="return onSubmit();">
									<input name="id" value="<%=t7166.F01 %>" type="text" style="display:none">
									<ul class="cell yw_jcxx ">
											...
											<div class="info">
												<select id="typeSelected" name="type" onchange="changeType(this.value);">
													<%T7166_F03[] t7166_F03s = T7166_F03.values(); if(t7166_F03s != null && t7166_F03s.length > 0){for(T7166_F03 t7166_F03:t7166_F03s ){ %>
														<option value="<%=t7166_F03.name() %>" <%if(t7166.F03 == t7166_F03){ %> selected<%} %>><%StringHelper.filterHTML(out, t7166_F03.getChineseName()); %></option>
													<%}} %>
												</select>
											...
											<div class="info">
												<select name="channel">
													<%T7166_F04[] t7166_F04s = T7166_F04.values(); if(t7166_F04s != null && t7166_F04s.length > 0){for(T7166_F04 t7166_F04:t7166_F04s){ %>
														<option value="<%=t7166_F04.name() %>" <%if(t7166.F04 == t7166_F04){ %> selected<%} %>><%StringHelper.filterHTML(out, t7166_F04.getChineseName()); %></option>
													<%}} %>
												</select>
												<p errortip class="" style="display: none"></p>
											</div>
										...
										<li id="sendTimeLi">
											...
											<div class="info">
											<%
											String sendTimeStr = SQLDateParser.format(new java.sql.Date(System.currentTimeMillis()));
											if(t7166.F09 != null){sendTimeStr = SQLDateParser.format(t7166.F09);}
											%>
												<input type="text" name="sendTime" readonly="readonly" id="datepicker1" class="yhgl_ser date required" value="<%=sendTimeStr %>" />
												<p errortip class="" style="display: none"></p>
											</div>
											<div class="clear"></div>
										</li>
										<li>
											...
											<div class="info">
												<input type="text" name="title" maxlength="30" class="text yhgl_ser yw_w5 required" value="<%StringHelper.filterHTML(out, t7166.F05); %>"/>
												<p tip></p>
												<p errortip class="" style="display: none"></p>
											</div>
											<div class="clear"></div>
										...
										<li>
											...
											<div class="info">
												<textarea name="content" cols="80" rows="9" style="width:700px;height:200px;"><%StringHelper.format(out,t7166.F06, fileStore); %></textarea>
												<p tip></p>
												<p errortip class="" style="display: none;"></p>
											</div>
											<div class="clear"></div>
