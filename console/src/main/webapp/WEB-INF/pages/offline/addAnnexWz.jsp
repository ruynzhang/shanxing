...
<%@page import="com.dimeng.p2p.console.servlets.offline.SetPic"%>
...
<%@page import="com.dimeng.p2p.console.servlets.offline.DelAnnexWz"%>
...
<%@page import="com.dimeng.p2p.console.servlets.offline.SaveLine"%>
...
<%@page import="com.dimeng.p2p.console.servlets.offline.AnnexWz"%>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="3" class="yhgl_table tc">
											...
											<tr>
												...
												<a href="<%=controller.getURI(request, ViewAnnexWz.class)%>?id=<%=t6233.F01%>" target="_blank">查看</a>&nbsp;<a
													href="<%=controller.getURI(request, DelAnnexWz.class)%>?loanId=<%=loanId%>&userId=<%=userId%>&id=<%=t6233.F01%>" onclick="return onDelete()">删除</a></td>
											</tr>
											<%}} %>
										</table>
									</div>
