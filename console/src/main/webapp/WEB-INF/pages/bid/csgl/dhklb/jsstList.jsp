        ...
        <div class="home_main">
          ...
          <div class="box box1 mb15">
            <div class="con">
                <div class="admin_input admin_pb">
                    ...
                    <p>下一还款日：<input type="text" readonly="readonly" name="createTimeStart" id="datepicker1" class="yhgl_input date" />至<input type="text" readonly="readonly" name="createTimeEnd" id="datepicker2" class="yhgl_input date" /></p>
                  	<div class="clear"></div>
                    <div class="mt10">
          ...
          <div class="newsbox">
            <div class="til clearfix">
              <div class="Menubox">
                <ul>
                  <li id="one1" class="hover" >近30天待还款</li>
            ...
            <div class="border p15 Men_bt no_table" id="con_one_2">
	          <table width="100%" border="0" cellspacing="0" cellpadding="3" class="yhgl_table">
	            <tr class="hsbg">
	              ...
	              <td align="center">距离下次还款</td>
	              <td align="center">下一还款日</td>
	              <td align="center">操作</td>
	            </tr>
	            <%if (near30Array != null) {for (int i =0;i<near30Array.length;i++){Near30 near30=near30Array[i];if (near30 == null) {continue;}%>
	            <tr class="dhsbg">
	              <td align="center"><%=i+1%></td>
	              <td><%StringHelper.filterHTML(out, near30.loanRecordTitle);%></td>
	              <td align="center"><%StringHelper.filterHTML(out, near30.userName);%></td>
	              <td align="center"><%=Formater.formatAmount(near30.loanAmount)%></td>
	              <td align="center"><%StringHelper.filterHTML(out, near30.loandeadline); %></td>
	              <td align="center"><%=Formater.formatAmount(near30.principalAmount)%></td>
	              <td align="center"><%=Formater.formatAmount(near30.residueAmount)%></td>
	              <td align="center"><%=near30.distanceRefund %>天</td>
	              <td align="center"><%=Formater.formatDate(near30.refundDay)%></td>
	              <td align="center">
	              	<%if(T6110_F06.ZRR == near30.userType){ %>
		              	...
		              	<span class="blue"><a href="<%=controller.getURI(request,com.dimeng.p2p.console.servlets.account.grxx.JbxxView.class)%>?userId=<%=near30.userId%>&status=1">个人资源</a></span>
		              	<%}else{ %>
		              ...
		              <%}else if(T6110_F06.FZRR == near30.userType && T6110_F10.F == near30.dbf){ %>
		              	...
		              	<span class="blue"><a href="<%=controller.getURI(request,com.dimeng.p2p.console.servlets.account.qyxx.jscl.UpdateJscl.class)%>?id=<%=near30.userId%>&status=1">企业资源</a></span>
		              	<%}else{ %>
		              ...
		              <%}else if(T6110_F10.S == near30.dbf){ %>
		             	<%if (dimengSession.isAccessableResource(com.dimeng.p2p.console.servlets.account.jgxx.jscl.UpdateJscl.class)) {%>
		              	<span class="blue"><a href="<%=controller.getURI(request,com.dimeng.p2p.console.servlets.account.jgxx.jscl.UpdateJscl.class)%>?id=<%=near30.userId%>&status=1">机构资源</a></span>
		              	<%}else{ %>
