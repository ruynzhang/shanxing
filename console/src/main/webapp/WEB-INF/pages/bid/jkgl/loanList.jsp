...
<%@page import="com.dimeng.p2p.console.servlets.bid.jkgl.BidZf"%>
...
<%@page import="com.dimeng.p2p.console.servlets.bid.jkgl.PreRelease"%>
...
<%@page import="com.dimeng.p2p.console.servlets.bid.jkgl.Release"%>
<%@page import="com.dimeng.p2p.S60.enums.T6036_F20"%>
<%@page import="com.dimeng.p2p.console.servlets.bid.jkgl.Check"%>
...
<body>
	...
	<div class="w_main">
		<div class="main clearfix">
			<div class="wrap">
				<div class="r_main">
					<form action="<%=controller.getURI(request, LoanList.class)%>" method="post">
					<div class="home_main">
						...
						<div>
							<table width="100%" border="0" cellspacing="0" cellpadding="3" class="yhgl_table tc">
								...
								<tr>
									...
									<td><%=Formater.formatAmount(loan.F05) %></td>
									<td><%=Formater.formatAmount(loan.F05.subtract(loan.F07)) %></td>
									<td><%=Formater.formatRate(loan.F06) %></td>
									<%-- <td><%=loan.F09 %>个月</td> --%>
									<td>
										<%if(T6231_F21.S == loan.F41){out.print(loan.F42); %>天
									...
									<td class="blue">
										...
										<%} %>
										<%
											if(dimengSession.isAccessableResource(BidZf.class)&&(loan.F20==T6230_F20.SQZ||loan.F20==T6230_F20.DSH))
											{
										%>
										<a href="<%=controller.getURI(request, BidZf.class) %>?loanId=<%=loan.F01 %>" onclick="return showZf('<%=loan.F03 %>')" class="mr5">作废</a>
										<%}else{%>
