...
<%@page import="com.dimeng.p2p.console.servlets.bid.jkgl.UpdateDywsx"%>
										...
										<li>
											...
											<div class="info orange">
												...
												<input type="hidden" name="t6235s[<%=i %>].F03" value="<%=t6235.F03%>"/>
												 <textarea id="t6235s<%=i %>" name="t6235s[<%=i %>].F04" cols="100" rows="8" style="width:700px;height:500px;visibility:hidden;"><%StringHelper.format(out, t6235.F04, fileStore); %></textarea>
												 <p id="errorContent">&nbsp;</p>
											</div>
											<div class="clear"></div>
										</li>
