            ...
            <div class="home_main">
            	<div class="box box1">
                    ...
                    <li>
                        ...
                        <div class="info"><%StringHelper.filterHTML(out, qyjkyx.F05);%></div>
                         <div class="clear"></div>
                    </li>
                     <li>
                        <div class="til">手机号码：</div>
                        <div class="info"><%StringHelper.filterHTML(out, qyjkyx.F06);%></div>
                         <div class="clear"></div>
                    </li>
                    <li>
                        <div class="til">意向借款金额：</div>
                        <div class="info"><%=Formater.formatAmount(qyjkyx.F09)%>元</div>
                         <div class="clear"></div>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <div class="info"><%StringHelper.filterHTML(out, qyjkyx.F12);%></div>
                         <div class="clear"></div>
                    </li>
                    <li>
                        <div class="til">借款描述：</div>
                        <div class="info"><%StringHelper.filterHTML(out, qyjkyx.F13);%></div>
                         <div class="clear"></div>
                    </li>
                    <li>
                    ...
                    <div class="tc w220"><input type="button" onclick="window.location.href='<%=controller.getURI(request, QyjkyxList.class)%>'" class="btn4" value="返回列表" /></div>
                    <div class="clear"></div>
                    </form>                  
                    </div>
                </div>
