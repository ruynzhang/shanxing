...
<body>
	...
	<div class="w_main">
		<div class="main clearfix">
			<div class="wrap">
				<div class="r_main">
					<div class="home_main">
						<form action="<%controller.getURI(request, KldhList.class);%>" method="post" name="form1" id="searchForm">
									...
									<div class="admin_input admin_pb">
             							<div class="table top3">
											...
											<P>
												...
												<%if (dimengSession.isAccessableResource(KldhListExport.class)) {%>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="3" class="yhgl_table tc">
								...
								<tr class="dhsbg">
									...
									<td><%
										...
										%></td>
									<td><%=DateTimeParser.format(excode.extendDate,"yyyy-MM-dd")%></td>
							...
							<%
							    KldhList.rendPagingResult(out, result);
							%>
	...
	function showExport()
	{
		document.getElementById("searchForm").action ="<%=controller.getURI(request, KldhListExport.class)%>";
		$("#searchForm").submit();
		document.getElementById("searchForm").action ="<%=controller.getURI(request, KldhList.class)%>";
	}
	$(function() {
