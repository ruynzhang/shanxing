          ...
          <div class="box box1 mb15">
            <div class="con">
                <div class="admin_input admin_pb">
                    ...
                    <p>债权人：<input type="text" name="userName" class="yhgl_input" value="<%StringHelper.filterHTML(out, request.getParameter("userName"));%>"/></p>
          ...
          <div class="newsbox">
	          <div class="til clearfix">
	             <div class="Menubox">
	               <ul>
	                 ...
	                 <li id="one3" class="hover" >已结清</li>
	                 <li id="one4" onclick="window.location.href='<%=controller.getURI(request, YzcList.class)%>'" style="border-right:1px #d7dfe3 solid;" >已转出</li>
	               </ul>
	             </div>
	          </div>
	          ...
	          <table width="100%" border="0" cellspacing="0" cellpadding="3" class="yhgl_table">
	            <tr class="hsbg">
	              ...
	              <td align="center">原始债权金额（元）</td>
	              <td align="center">结清时间</td>
	            </tr>
	            <%
	            ...
	            <tr class="dhsbg">
	              ...
	              <td align="center"><%=creditor.creditorId%></td>
	              <td>
	              	<%
	              ...
	              <td align="center"><%=Formater.formatAmount(creditor.investmentAmount)%></td>
