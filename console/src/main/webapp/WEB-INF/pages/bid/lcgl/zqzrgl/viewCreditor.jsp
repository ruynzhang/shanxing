            ...
            <div class="clear"></div>
           	  ...
           	  <div class="newsbox">
           	    ...
           	    <div class="border p15-30 Men_bt no_table" id="con_one_3">
           	      <div class="fr mb10"> <span class="mr10">持有债权人数<em class="f18 orange"><%if (creditorInfos != null) {%><%=creditorInfos.length%><%}else{ %>0<%} %></em>人</span></div>
           	      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="yhgl_table tc mb15">
                      ...
                      <%if (creditorInfos != null) {for (int i = 0;i < creditorInfos.length;i++) {CreditorInfo creditorInfo = creditorInfos[i];if (creditorInfo == null) {continue;}%>
                      <tr>
                        <td><%=i+1%></td>
                        <td><%StringHelper.filterHTML(out, creditorInfo.userName);%></td>
                        <td><%=creditorInfo.tenderTime %></td>
                      </tr>
                      <%}} %>   
              	 	  </table>
       	        </div>
