          ...
          <div class="box box1 mb15">
            <div class="con">
                <div class="admin_input admin_pb">
                    <p>投标人：<input type="text" name="userName" class="yhgl_input" value="<%StringHelper.filterHTML(out, request.getParameter("userName"));%>"/></p>
