            ...
            <div class="clear"></div>
           	  ...
           	  <div class="newsbox">
           	    ...
           	    <div class="border p15-30 Men_bt no_table" id="con_one_2">
           	      <div class="fr mb10"> <span class="mr10">加入人次<em class="f18 orange"><%=tenderRecord==null?0:tenderRecord.totalNumber %></em>人</span> <span class="mr10">投标总额<em class="f18 orange"><%=Formater.formatAmount(tenderRecord.totalMoney) %></em>元</span> </div>
           	      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="yhgl_table tc mb15">
                      ...
                      <%if (tenderInfos != null) {for (int i = 0;i < tenderInfos.length;i++) {TenderInfo tenderInfo = tenderInfos[i];if (tenderInfo == null) {continue;}%>
                      <tr>
                        <td><%=i+1%></td>
                        <td><%StringHelper.filterHTML(out, tenderInfo.userName);%></td>
                        <td><%=Formater.formatAmount(tenderInfo.tenderMoney) %>元</td>
                        <td><%=TimestampParser.format(tenderInfo.tenderTime) %></td>
                      </tr>
                      <%}} %>      
              	 	  </table>
       	        </div>
