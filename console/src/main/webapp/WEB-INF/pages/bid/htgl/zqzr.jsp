...
<%@page import="com.dimeng.p2p.modules.bid.console.service.entity.DzxyZqzr"%>
...
%>
<p class="clearfix pt10"><a target="_blank" href="<%=controller.getURI(request, Zqzr.class)%>?id=<%=creditId%>&s=1" class="btn btn01 fr">点击下载</a></p>
<%
