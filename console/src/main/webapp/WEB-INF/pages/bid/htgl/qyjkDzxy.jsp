...
<div class="w_main">
  <div class="main clearfix">
    <div class="wrap">
      <div class="r_main">
        <div class="home_main">
        <form action="<%=controller.getURI(request, QyjkDzxy.class)%>" method="post">
          ...
          <div class="newsbox">
            <div class="til clearfix">
              <div class="Menubox">
                <ul>
                  <li class="hover">企业借款协议</li>	
                  <li onclick="window.location.href='<%=controller.getURI(request, GrjkDzxy.class)%>'" >个人借款协议</li>
