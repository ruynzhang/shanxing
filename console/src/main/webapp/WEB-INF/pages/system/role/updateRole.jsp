					...
					<div class="home_main">
						<div class="box box1 mb15">
							...
							<div class="con" style="padding: 30px 0">
								<div class="clear"></div>
								<form action="<%=controller.getURI(request, UpdateRole.class)%>" method="post" class="form1">
								<input name="roleId" type="hidden" id="roleId" value="<%=roleBean.roleId%>"/>
									<ul class="cell yw_jcxx ">
										<li>
											...
											<div class="info">
												<input name="name" type="text" class="text yhgl_ser yw_w5 required" maxlength="15" value="<%=roleBean.roleName%>"/>
												<p tip></p>
										...
										<li>
											...
											<div class="info">
												<textarea name="des" id="des" cols="45" rows="5" class="border fl mr10 yw_w5" maxlength="200"><%=roleBean.desc%></textarea>
												<p id="errordes">&nbsp;</p>
											</div>
											<div class="clear"></div>
										</li>
