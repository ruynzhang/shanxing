        ...
        <div class="r_main">
            <div class="home_main">
            	<div class="box box1 mb15">
                    ...
                    <li>
                        <div class="til"><span class="red">*</span>显示顺序：</div>
                        <div class="info">
                        	<input name="F03" type="text" class="text yhgl_ser required isint" value="<%=entity.F03%>"/>
                        	<p tip></p>
							<p errortip class="fl" style="display: none"></p>
						</div>
                        <div class="clear"></div>
                    ...
                    <div class="tc w220 pt20">
                    	...
                    	<input type="button" onclick="window.location.href='<%=controller.getURI(request, BfjlxList.class)%>'" class="btn4" value="返回列表页" />
                    </div>
                	<div class="clear"></div>
                    </form>
                    <div class="clear"></div>
