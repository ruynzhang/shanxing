        ...
        <div class="r_main">
            <div class="home_main">
            	<div class="box box1 mb15">
                    ...
                    <div class="con">
                    <form action="<%=controller.getURI(request, ViewBlx.class)%>" method="post" class="form1">
                    ...
                    <div class="tc w220 pt20">
                    	...
                    	<input type="button" onclick="window.location.href='<%=controller.getURI(request, BlxList.class)%>'" class="btn4" value="返回列表页" />
                    </div>
                	<div class="clear"></div>
                    </form>
                    <div class="clear"></div>
