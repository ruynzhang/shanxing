        ...
        <div class="r_main">
            <div class="home_main">
            	<div class="box box1 mb15">
                    ...
                    <div class="con">
                    <form action="<%=controller.getURI(request, AddXydj.class)%>" onSubmit="return onSubmit();" method="post" class="form1">
                    <ul class="cell noborder yxjh ">
                    <li>
                        <div class="til"><span class="red">*</span>等级名称：</div>
                        <div class="info">
                        	<input name="F02" type="text" class="text yhgl_ser required max-length-20" />
                        	<p tip></p>
                    ...
                    <li>
                        ...
                        <div class="info">
                        	<input name="F03" maxlength="10" type="text" class="text yhgl_ser required isint"/>
                        	<p tip></p>
							<p errortip class="" style="display: none"></p>
                        </div>
                        <div class="clear"></div>
                    ...
                    <li>
                        ...
                        <div class="info">
                        	<input name="F04" maxlength="10" type="text" class="text yhgl_ser required isint"/>
                        	<p tip></p>
							<p errortip class="" style="display: none"></p>
                        </div>
                        <div class="clear"></div>
