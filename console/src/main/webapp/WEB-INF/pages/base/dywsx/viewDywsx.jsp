            ...
            <div class="home_main">
            	<div class="box box1 mb15">
                    ...
                    <li>
                    	...
                    	<div class="info">
							<select name="F02" class="yhgl_sel">
	                        	...
	                        	%>
								<option value="<%=dywType.F01%>" <%if (dywType.F01 == entity.F02) {%> selected="selected" <%}%>><%StringHelper.filterHTML(out, dywType.F02);%></option>
								<%
								}
								%>
		                    </select>
                    ...
                    <li>
                        ...
                        <div class="info">
                        	<input name="F03" type="text" class="text yhgl_ser required" value="<%StringHelper.filterHTML(out, entity.F03);%>"/>
                        	<p tip></p>
