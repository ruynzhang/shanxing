        ...
        <div class="r_main">
            <div class="home_main">
            	<div class="box box1 mb15">
                    ...
                    <div class="con">
                    <form action="<%=controller.getURI(request, AddXyrzx.class)%>" method="post" class="form1">
                        ...
                        <div class="info">
                        	<span class="tir required">
                          		<select name="F03" class="yhgl_sel" style="width:300px;">
									...
									%>
									<option value="<%=t5123_F03.name()%>"><%=t5123_F03.getChineseName()%></option>
									<%
										}
									%>
                          		</select>
                    ...
                    <li>
                        ...
                        <div class="info">
                        	<input name="F05" type="text" class="text yhgl_ser required isint"/>
                        	<p tip></p>
							<p errortip class="fl" style="display: none"></p>
                        </div>
                        <div class="clear"></div>
