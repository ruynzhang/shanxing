...
<%@page import="com.dimeng.p2p.pay.servlets.Login"%>
...
<link href="<%=controller.getStaticPath(request)%>/mobile/css/mobile.css" rel="stylesheet" type="text/css" media="screen">
...
<script src="<%=controller.getStaticPath(request)%>/mobile/js/common.js" type="text/javascript" ></script>
</head>
<body>
...
<div id="sx_m_main">
    <div class="sx_m_block4 sx_m_block_login" id="sx_reg">
        <p>我们的平台即将上线，届时举办新闻发布会，新的一轮大抽奖随之而来,我们的官网：http://www.myshanxing.com</p><br />
        <ul>
          <li><input type="text" id="accountName" name="accountName" placeholder="帐号（昵称）" maxlength="18"  onblur="accountCheck()" class="sx_input"></li>
          <li>
          <input type="password" name="password" id="showPwd" onblur="passwordCheck()" placeholder="密码" class="sx_input">
          <input  name="showPwd" type="password" class="sx_input"  maxlength="20"  value="密码" style="display: none;"/></li>
          <li class="sx_login_liend"><input type="submit" value="登&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;陆" class="sx_orangeBt"/></li>
      </ul>
      <p class="sx_reg_word">还没有帐号？<a href="<%= controller.getStaticPath(request)%>/mobileRegister.html" class=" sx_blueColor">立即注册</a></p>
    </div>
</div>
</form>
