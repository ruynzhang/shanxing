...
public class InvestHk extends AbstractMobileServlet {
	...
	protected void processPost(final HttpServletRequest request,
		...
		PagingResult<ZqxxEntity> list= manage.getRecoverAssests(0,new Paging() {
			@Override
			public int getSize() {
				return size;
			}
		...
		if (vos != null && vos.length > 0) {
			for (ZqxxEntity vo : vos) {
        		...
        		buff.append("\"proSj\":\"").append(Formater.formatAmount(vo.dsbx.subtract(vo.F04))).append("\",");
