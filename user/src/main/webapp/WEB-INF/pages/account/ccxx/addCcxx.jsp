					...
					<form action="<%=controller.getURI(request, AddCcxx.class) %>" class="form1" method="post">
						...
						<ul>
							<li>
								...
								<div class="info">
									<input type="text" name="F03" value="<%StringHelper.filterHTML(out, request.getParameter("F03"));%>" class="yhgl_ser w200 required max-length-30" />
									<p tip></p>
							...
							<li>
								...
								<div class="info">
									<input type="text" name="F04" value="<%StringHelper.filterHTML(out, request.getParameter("F04"));%>" class="yhgl_ser w200 required max-length-20" />
									<p tip></p>
									<p errortip class="" style="display: none"></p>
								</div>
								<div class="tir"></div>
							...
							<li>
								...
								<div class="info">
									<input type="text" name="F05" value="<%StringHelper.filterHTML(out, request.getParameter("F05"));%>" class="yhgl_ser w200 required isint max-length-5" />年
									<p tip></p>
									<p errortip class="" style="display: none"></p>
								</div>
								<div class="tir"></div>
							...
							<li>
								...
								<div class="info">
									<input type="text" name="F06" value="<%StringHelper.filterHTML(out, request.getParameter("F06"));%>" class="yhgl_ser w200"  maxlength="15" mtest="/^((([1-9][0-9]*)|0)|((([1-9][0-9]*)|0)\.[0-9]{1,2}))$/" mtestmsg="必须为数字格式(且是两位小数)" />
									<p tip></p>
									<p errortip class="" style="display: none"></p>
								</div>
								<div class="tir"></div>
								...
								<div class="info">
									<input type="text" name="F07" value="<%StringHelper.filterHTML(out, request.getParameter("F07"));%>" class="yhgl_ser w200" maxlength="9" mtest="/^((([1-9][0-9]*)|0)|((([1-9][0-9]*)|0)\.[0-9]{1,2}))$/" mtestmsg="必须为数字格式(且是两位小数)" />
									<p tip></p>
									<p errortip class="" style="display: none"></p>
								</div>
								<div class="tir"></div>
