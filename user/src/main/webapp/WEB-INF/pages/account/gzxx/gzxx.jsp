	...
	<div class="contain clearfix">
		...
		<div class="about">
			...
			<div class="container fr">
				...
				<br/>
				<a href="<%=controller.getURI(request, AddGzxx.class)%>" class="btn01"">新增</a>
				<br/>
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<td>
							<a href="<%=controller.getURI(request, ViewGzxx.class) %>?id=<%=t.F01 %>" class="blue">查看</a>
							<a href="<%=controller.getURI(request, UpdateGzxx.class) %>?id=<%=t.F01 %>" class="blue ml5">修改</a>
						<td>
					</tr>
					<%}} %>
				</table>
