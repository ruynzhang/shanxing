...
<div class="wx_login_box">
        ...
        <div class="input_box">
            <input type="password"  placeholder="原密码"  name="password" id="old_pass" class=" input_text" >
        </div>
        <div class="input_box">
            <input type="password"  placeholder="密码"  name="password" id="new_pass" class=" input_text" >
        </div>
        <div class="input_box">
            <input type="password"  placeholder="确认密码"  name="password" id="new_pass2" class="input_text" >
        </div>
...
onSubmit=function(){
	...
	$.ajax({
		type : "POST",
		url : "/user/mobile/updPassword.htm",
